...
# ===========================================
# 2) EXISTING ENTERPRISE CSS (KEEP ORIGINAL)
# ===========================================

def apply_enterprise_css():
    st.markdown("""
        <style>
            /* Hoàng đang dùng theme Premium Green ở các bản trước */
            body {
...
# ===========================================
# 3) NEON PREMIUM V6 (NEW)
# ===========================================

def load_neon_premium_styles():
    st.markdown("""
    <style>

    /* =========================================================
       NEON PREMIUM v6 — Recommendation Card
